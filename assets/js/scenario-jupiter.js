...
export const SCRIPT = [
  ...
  {min:15, plat:'x',  who:'examiner',  text:'We are getting reports of a fire at The Kirkwood Hospice in Dalton. Emergency services are on scene. @TheKirkwoodHD are you able to confirm what is happening?', note:'First direct media approach. Clock starts on their response.'},
  {min:17, plat:'fb', who:'karen',     text:'my dad is in the inpatient unit at the kirkwood. can anyone tell me whats happening please. ive rang twice and cant get through', note:'HIGH IMPACT — family member, publicly identifiable relative, asking on an open page.'},
  ...
  {min:31, plat:'fb', who:'mohammed',  text:'My mother is a patient there. I have had no phone call. I am finding this out from Facebook. Why is nobody telling the families anything??', packRef:'T+35', note:'HIGH IMPACT — the "I found out online" complaint. This is the one that stings.'},
  ...
  {min:43, plat:'x',  who:'examiner',  text:'@TheKirkwoodHD We have now approached The Kirkwood three times for comment. Can you confirm whether all patients are safe?', note:'Public escalation of an unanswered enquiry.'},
  ...
  {min:54, plat:'x',  who:'reporter',  text:'Reporting on the fire at The Kirkwood in Huddersfield. If you are a family member or member of staff affected and willing to talk, my DMs are open.', note:'Journalist going directly to staff and families around the comms team.'},
  {min:55, plat:'x',  who:'regional',  text:'We have requested an interview with The Kirkwood. Our reporter is at the scene for the 18:00 bulletin. @TheKirkwoodHD', packRef:'T+55', note:'PACK T+55 — interview request with a hard broadcast deadline.'},
  ...
  {min:63, plat:'fb', who:'sarahm',    text:'Has anyone been contacted by the hospice? Genuine question. My aunt is a patient and we have heard nothing at all.'},
  ...
  {min:68, plat:'fb', who:'fiona',     text:'Message going round the staff group asking if evening shift should still come in. Nobody seems to know. Has anyone heard officially?', packRef:'T+70', note:'PACK T+70 — workforce instruction gap, surfacing publicly instead of internally.'},
  ...
  {min:88, plat:'fb', who:'diane',     text:'Two relatives have just turned up at the gate and been turned away. That cant be right can it? They just want to know their family are alive.', packRef:'T+95', note:'PACK T+95 — families arriving on site despite the message not to attend.'},
  {min:90, plat:'x',  who:'regional',  text:'Our 18:00 bulletin will lead on the Huddersfield hospice fire. We would still welcome a statement or interview from @TheKirkwoodHD.'},
  {min:93, plat:'fb', who:'nikki',     text:'Whoever is running that hospices Facebook page — people just need to hear something. Anything. Even just "we are here and everyone is safe".'},
  ...
  {min:113,plat:'x',  who:'examiner',  text:'@TheKirkwoodHD Following up — can you confirm how many inpatients have been transferred and where families should direct enquiries this evening?', packRef:'T+110'},
  {min:116,plat:'fb', who:'mohammed',  text:'I would like to say that once someone did ring me they were very kind and very clear. It was the two hours before that were unbearable.', note:'Fair, measured criticism. Harder to dismiss than anger.'},
  {min:120,plat:'x',  who:'exstaff',   text:'glad everyones safe. still think theres questions to answer about that corridor.'},
  {min:124,plat:'fb', who:'tracy',     text:'Is the hospice open tomorrow? My mum has day therapy on Thursdays and nobody has said anything.', note:'Business continuity comms — the services nobody has thought about yet.'},
  ...
  {min:132,plat:'fb', who:'gary',      text:'Genuine question — where do people go now if they need hospice care this week? Asking as a family who might need them.'},
